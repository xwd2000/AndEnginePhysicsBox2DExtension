...
public class PhysicsWorld implements IUpdateHandler {
	...
	public Iterator<Body> getBodies() {
		Array<Body> arrayBody=new Array<Body>();
		this.mWorld.getBodies(arrayBody);
		return arrayBody.iterator();
	}
	...
	public List<Contact> getContactList() {
		Array<Contact> array=this.mWorld.getContactList();
		
		List<Contact> contactList = Arrays.asList(array.items);
		return contactList;
	}
	...
	public Iterator<Joint> getJoints() {
		Array<Joint> arrayJoint=new Array<Joint>();
		this.mWorld.getJoints(arrayJoint);
		return arrayJoint.iterator();
	}
